...
const ImageCard: React.FC<ImageCardProps> = ({ label, imageUrl, isLoading = false, progress = 0 }) => (
    <div className="w-full flex flex-col items-center space-y-3 bg-gray-800/50 p-4 rounded-2xl shadow-lg">
        ...
        <div className="w-full aspect-square bg-gray-900/50 rounded-lg flex items-center justify-center overflow-hidden border border-gray-700 relative">
            {isLoading && (
                <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4 text-indigo-400 p-4">
                    <LoaderIcon className="w-12 h-12 animate-spin" />
                    <p className="font-semibold">جاري المعالجة...</p>
        ...
        if (isLoading) {
            ...
            progressIntervalRef.current = window.setInterval(() => {
                setProgress(prev => {
                    ...
                    return prev + (100 - prev) / 25; // Simulate progress
                });
            }, 200);
        } else {
                ...
                {!originalFile ? (
                    ...
                    <div className="w-full flex flex-col items-center space-y-6">
                        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <ImageCard label="النتيجة" imageUrl={processedImageUrl} isLoading={isLoading} progress={progress} />
                        </div>
